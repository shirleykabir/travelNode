...
def callCaroline(orgdata, data1, time):
    # print "WEtjw" + str(data1)
    own_vehicle = "no"
    max_time = orgdata["timelimit"]
    activity_level = orgdata["active"]
    results = construct_whole(data1, time, own_vehicle, max_time, activity_level)
    return results

#
# [(u'111 Dryden Rd, Ithaca, NY 14850, USA', u'232 East Ave, Ithaca, NY 14850, USA', 240, 9.0, 988, 0.7), (u'111 Dryden Rd, Ithaca, NY 14850, USA', u'Ithaca Tompkins Regional Airport, 1 Culligan Dr, Ithaca, NY 14850, USA', 660, 15.0, 5564, 4.4), (u'232 East Ave, Ithaca, NY 14850, USA', u'Ithaca Tompkins Regional Airport, 1 Culligan Dr, Ithaca, NY 14850, USA', 600, 13.0, 4631, 3.7)]
